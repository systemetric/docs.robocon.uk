...
"first-steps/getting-started.md": {
	id: "first-steps/getting-started.md";
  slug: "first-steps/getting-started";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
...
"tools/brainbox-crashed-fix.md": {
	id: "tools/brainbox-crashed-fix.md";
  slug: "tools/brainbox-crashed-fix";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
